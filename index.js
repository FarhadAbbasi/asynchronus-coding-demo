...
// prepfood ((value)=> { console.log("value =", value);  } ) ;

// function mycallback(value) {
//     console.log("food callback =", value);
//     preptoast(toastcallback);
// }

// function toastcallback(value) {
//     console.log("toast callback =", value);
//     prepcoffee(coffeecallback);
// }

// function coffeecallback(value) {
//     console.log("coffeecallback =", value);
// }
